            ...
            <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="address">
                    ...
                    <div class="address__details">
                        ...
                        <p>Sivrihisar, Eskisehir Turkey </p>
                    </div>
                </div>
                <div class="address">
                    <div class="address__icon">
                    ...
                    <div class="address__details">
                        <h2 class="ct__title">openning hour: Whenever I want</h2>
                        <p> Whenever I want </p>
                    </div>
                </div>
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(39.44608169911044, 31.531806811062758), // New York
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(39.44608169911044, 31.531806811062758),
        map: map,
        title: 'Ramble!',
